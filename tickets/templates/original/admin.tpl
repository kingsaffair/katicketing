...
{% load static %}
{% block head %}
	<link rel="stylesheet" href="{% static 'legacy/css/admin.css' %}" />
	<script type="text/javascript" src="http://ajax.googleapis.com/ajax/libs/jquery/1.6.1/jquery.min.js"></script>
	<script type="text/javascript" src="{% static 'legacy/js/highcharts.js' %}"></script>
