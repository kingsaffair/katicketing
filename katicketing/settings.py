"""
Django settings for katicketing project.
...
SECRET_KEY = '7e8czjlh&+k8-x(p40!)%3(r%jc&ag-m_%=h&!od1bd!2g)wkg'
...
UCAMWEBAUTH_RETURN_URL = 'http://localhost:8000/raven_return/'
UCAMWEBAUTH_LOGOUT_REDIRECT = 'http://www.kingsaffair.com/'
...
WSGI_APPLICATION = 'katicketing.wsgi.application'
